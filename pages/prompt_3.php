...
if (isset($_POST['prompt3'])) {
   $promptFetchQuery = "SELECT prompt_three FROM prompt3 where unique_code = '$unique_code'";
   ...
   if ($run) {
      ...
      if (mysqli_num_rows($run) > 0) {
         ...
         $answer = $row['prompt_three'];
      } else {
         $getuserdata = "SELECT * FROM prompt2 where unique_code = '$unique_code'";
         ...
         while ($row = mysqli_fetch_assoc($query_run)) {
            ...
            $question = $assign . $row['prompt_two'] . " Donne moi un exemple de résultat attendu?";
            ...
            $query = "INSERT INTO prompt3 (prompt_three,unique_code) VALUES (?, ?)";

            // Prepare the statement
            $stmt = mysqli_prepare($conn, $query);

            // Bind the parameters
            mysqli_stmt_bind_param($stmt, "ss", $prompt_three, $unique_code);
...
<body>
   ...
   <div class="container-samad">
      ...
      <h1 class="title-samad-prompt1">Voir un exemple</h1>
         ...
         <div class="prompt-box">
            <div class="page-samad">
               ...
               <div class="field btns">
                  <form>
                     <button class="prev" id="" name=""><a href="./prompt_1.php" class="">Retour au use
                           case</a></button>
                  </form>
                  <form action="./prompt_2.php" method="post">
                     <button class="submit" id="prompt3" name="prompt2">Voir un exemple</button>
                  </form>
